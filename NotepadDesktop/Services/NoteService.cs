...
namespace NotepadDesktop.Services
{
    public class NoteService
    {
        ...
        public List<Note> GetAll() =>
            _notes.OrderByDescending(n => n.IsPinned).ThenByDescending(n => n.UpdatedAt).ToList();
        ...
        public void TogglePin(int id)
        {
            ...
            if (note != null) { note.IsPinned = !note.IsPinned; Save(); }
        }
